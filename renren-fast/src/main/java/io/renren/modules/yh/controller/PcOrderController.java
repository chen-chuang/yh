...
public class PcOrderController extends AbstractController{
	
	private static final Logger LOG = LoggerFactory.getLogger(PcOrderController.class);
	@Autowired
	 ...
	 */
	@RequestMapping("/list")
	@RequiresPermissions("pcorder:list")
	...
	@RequiresPermissions("pcorder:info")
	...
	@RequiresPermissions("pcorder:update")
	...
	@RequiresPermissions("pcorder:choiceDelivery")
	...
	@RequiresPermissions("pcorder:print")
